        ...
        try {
            for (Field field : object.getClass().getDeclaredFields()) {
                try {
                    ...
                    Logger.getInstance().error("Failed to close field {%s} of object %s", field.getName(), object.getClass().getName());
                }
            }
        } catch (Exception e) {
            Logger.getInstance().error("Error finalizing object: %s", object.getClass().getName());
        } finally {
            object = null;
        }
    }
